 ...
 * @since 1.0.0
 */
class Poco_Elementor_Brand extends Elementor\Widget_Base {
    ...
    public function get_script_depends() {
        return ['poco-elementor-brand', 'slick'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'brand_title',
            [
                'label'       => esc_html__('Brand name', 'poco'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Brand Name', 'poco'),
                'placeholder' => esc_html__('Brand Name', 'poco'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'type_brand',
            [
                'label'   => esc_html__('Type', 'poco'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'image' => esc_html__('Image', 'poco'),
                    'icon'  => esc_html__('Icon & SVG', 'poco'),
                ],
                'default' => 'image',
            ]
        );
        ...
        $this->start_controls_section(
            'style_brand_icon',
            [
                'label' => esc_html__('Icon & SVG', 'poco'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'icon_color_hover',
            [
                'label'     => esc_html__('Primary Color', 'poco'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                        ...
                        <div <?php echo poco_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <div class="elementor-brand-image">
                                ...
                                if (!empty($item['link'])) {
                                    ...
                                    echo '<a href="' . esc_url($item['link']['url'] ? $item['link']['url'] : '#') . '" ' . poco_elementor_get_render_attribute_string('brand-image', $this) . ' title="' . esc_attr($item['brand_title']) . '">';
                                }
                                ...
                                if ($item['type_brand'] == 'image') {
                                    ...
                                    if ($is_new || $migrated) {
                                        ...
                                        <i <?php echo poco_elementor_get_render_attribute_string('icon', $this); // WPCS: XSS ok. ?>></i>
                                        <?php
                                    }
                                }
                                if (!empty($item['link'])) {
...
$widgets_manager->register(new Poco_Elementor_Brand());
